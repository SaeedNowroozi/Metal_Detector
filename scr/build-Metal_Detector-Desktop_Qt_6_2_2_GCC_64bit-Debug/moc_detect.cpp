...
#include <memory>
#include "../Metal_Detector/detect.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Detect_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Detect_t qt_meta_stringdata_Detect = {
    {
QT_MOC_LITERAL(0, 6) // "Detect"
...
const QMetaObject Detect::staticMetaObject = { {
    ...
    qt_meta_stringdata_Detect.offsetsAndSize,
    qt_meta_data_Detect,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Detect_t
, QtPrivate::TypeAndForceComplete<Detect, std::true_type>
